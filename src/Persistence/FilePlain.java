...
public class FilePlain {
	...
	public void writeFile(String dates) throws IOException{
		BufferedWriter output=new BufferedWriter(Files.newBufferedWriter(path,Charset.defaultCharset(),StandardOpenOption.WRITE,StandardOpenOption.CREATE,StandardOpenOption.TRUNCATE_EXISTING));
