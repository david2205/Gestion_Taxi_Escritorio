...
public class DelDriver extends JInternalFrame  implements KeyListener{
	...
	public DelDriver(WindowsAdmin window,JDesktopPane desktop){
		this.window=window;
	...
	private void addElements() {
		...
		gbc.gridy=0;
		gbc.gridwidth=3;
		add(new JLabel("Eliminar Conductor"),gbc);
		
		gbc.gridx=2;
		gbc.gridy=1;
		gbc.gridwidth=3;
		JLabel btn=new JLabel();
		ImageIcon icono=new ImageIcon("resources/icons/delD.png");
		btn.setIcon(icono);
		add(btn,gbc);
	...
	private void beginElements() {
		...
		del.setActionCommand(ActionsControll.DEL_DRIVER);
		del.addActionListener(window.getControll());
		
		modelTab=new DefaultTableModel(new String[] {"Nombre","Celular","Usuario"}, 0);
